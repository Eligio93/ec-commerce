...
export default function CartControllerBar({ existingCartProduct }: { existingCartProduct: CartProduct }) {
    const {
        addOne,
        removeOne,
        setQuantity,
    ...
    return <div className="border rounded-lg p-1 lg:p-3 flex gap-1 z-100">
        <div className="w-[20px] h-[20px] cursor-pointer" onClick={decreaseOne}>
            <Image
                src={minusCartIcon}
        ...
        <input id='numberInputCart' className="flex-1 text-center outline-orange-500 " type='number' min={0} max={10} value={newQuantity} onChange={handleChange} />
        <div className=" w-[20px] h-[20px] cursor-pointer" onClick={increaseOne}>
            <Image
                src={plusCartIcon}
                alt="add Item Icon" />
        </div>
